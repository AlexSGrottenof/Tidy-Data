...
The values in the Tidy data are the means of the aggregate values by Subject and Activity for the variables described below.

The variable descriptions were provided with the original dataset. As the variable
names were kept in the Tidy Dataset this Code Book looks similar to the 
original Codebook.
